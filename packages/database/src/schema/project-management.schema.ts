...
export const projects = pgTable('projects', {
  ...
  claimsConstraints: jsonb('claims_constraints'),
  ...
  seoCompetitors: jsonb('seo_competitors'),
  seoCompetitorKeywordMap: jsonb('seo_competitor_keyword_map'),
...
export const projectMarkerPlacements = pgTable('project_marker_placements', {
  ...
  marketLocationName: text('market_location_name'),
